...
while capture.isOpened():
    ...
    if results.face_landmarks is not None:
        ...
        # print(int(face_idx[54][0]*image.shape[1]), int(face_idx[54][1]*image.shape[0]))
        # cv2.rectangle(img=image,
        #               pt1=(int(face_idx[54][0]*image.shape[1]), int(face_idx[54][1]*image.shape[0])),
        #               pt2=(int(face_idx[397][0]*image.shape[1]), int(face_idx[397][1]*image.shape[0])),
        #               color=(255, 255, 255),
        #               thickness=3)
            ...
            if len(rps_result) >= 1:
                ...
                if rps_result[0]['rps'] == 'filter1':
                    ...
                    frame = overlay_transparent(frame,
                                                overlay,
                                                int(face_idx[1][0] * image.shape[1]),
                                                int(face_idx[1][1] * image.shape[0]),
